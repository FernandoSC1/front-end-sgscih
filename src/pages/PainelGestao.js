...
const PainelGestao = ({ setCurrentPage, setSelectedPacienteId }) => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'investigacoes':
                return <InvestigacoesAtivas setCurrentPage={setCurrentPage} setSelectedPacienteId={setSelectedPacienteId} />;
            default:
                return <AtualizacoesDiarias setCurrentPage={setCurrentPage} setSelectedPacienteId={setSelectedPacienteId} />;
        }
    };
