            ...
            <ul className="report-list">
              {culturas.map((cultura) => (
                <li key={cultura._id} className="data-item">
                  <p><strong>Tipo:</strong> {cultura.tipoCultura}</p>
                  <p><strong>Data da Coleta:</strong> {formatDate(cultura.dataColeta)}</p>
                  <p><strong>Data do Resultado:</strong> {formatDate(cultura.dataResultado) || 'N/A'}</p>
                  <p><strong>Resultado:</strong> {cultura.resultado || 'N/A'}</p>
                  <div className="item-actions">
            ...
            <ul className="report-list">
              {antimicrobianos.map((antimicrobiano) => (
                <li key={antimicrobiano._id} className="data-item">
                  <p><strong>Medicamento:</strong> {antimicrobiano.nomeMedicamento}</p>
                  <p><strong>Início:</strong> {formatDate(antimicrobiano.inicioTratamento)}</p>
                  <p><strong>Fim:</strong> {antimicrobiano.fimTratamento ? formatDate(antimicrobiano.fimTratamento) : 'Em andamento'}</p>
                  <p><strong>Houve Troca:</strong> {antimicrobiano.houveTroca ? 'Sim' : 'Não'}</p>
                  <p><strong>Prorrogação:</strong> {antimicrobiano.prorrogacaoPrescricao ? 'Sim' : 'Não'}</p>
                  <div className="item-actions">
